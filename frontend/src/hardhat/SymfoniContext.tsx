...
export const RoleRegistryContext = React.createContext<SymfoniRoleRegistry>(emptyContract);
...
export interface SymfoniRoleRegistry {
    instance?: RoleRegistry;
    factory?: RoleRegistry__factory;
}
...
export const Symfoni: React.FC<SymfoniProps> = ({
    ...
    useEffect(() => {
        ...
        const doAsync = async () => {
            ...
            const finishWithContracts = (text: string) => {
                setRoleRegistry(getRoleRegistry(_provider, _signer))
    ...
    const getRoleRegistry = (_provider: providers.Provider, _signer?: Signer) => {

        const contractAddress = RoleRegistryDeployment.receipt.contractAddress
        const instance = _signer ? RoleRegistry__factory.connect(contractAddress, _signer) : RoleRegistry__factory.connect(contractAddress, _provider)
        const contract: SymfoniRoleRegistry = {
            instance: instance,
            factory: _signer ? new RoleRegistry__factory(_signer) : undefined,
        }
        return contract
    }
        ;
    const getAuthProvider = (_provider: providers.Provider, _signer?: Signer) => {
        ...
        const contractAddress = AuthProviderDeployment.receipt.contractAddress
        const instance = _signer ? AuthProvider__factory.connect(contractAddress, _signer) : AuthProvider__factory.connect(contractAddress, _provider)
            ...
            <ProviderContext.Provider value={[provider, setProvider]}>
                <SignerContext.Provider value={[signer, setSigner]}>
                    <CurrentAddressContext.Provider value={[currentAddress, setCurrentAddress]}>
                        <RoleRegistryContext.Provider value={RoleRegistry}>
